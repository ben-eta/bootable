...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs_mmc=setenv bootargs ${bootargs} "     \
			"root=/dev/mmcblk0p1 rootwait video=mxcfb0:dev=ldb,LDB-XGA,if=RGB666,bpp=32 ldb=sin0 video=mxcfb1:dev=hdmi,1280x720M@60,if=RGB24,bpp=32  video=mxcfb2:off video=mxcfb3:off androidboot.hardware=freescale \0"                \
